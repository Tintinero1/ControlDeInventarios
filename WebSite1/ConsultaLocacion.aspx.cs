...
public partial class ConsultaCliente : System.Web.UI.Page
{
    ...
    protected void btnConsultaLocacion_Click(object sender, EventArgs e)
    {
        ...
        gvClientes.DataSource = bl.ConsultaLocacion(nombre, estatus);
        gvClientes.DataBind();
    }

    public void RefreshTableData()
    {
        gvClientes.DataSource = bl.ConsultaAlmacen(" "," ");
        gvClientes.DataBind();
